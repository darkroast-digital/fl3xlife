...
__webpack_require__.m=modules;__webpack_require__.c=installedModules;__webpack_require__.i=function(value){return value};__webpack_require__.d=function(exports,name,getter){if(!__webpack_require__.o(exports,name)){Object.defineProperty(exports,name,{configurable:!1,enumerable:!0,get:getter})}};__webpack_require__.n=function(module){var getter=module&&module.__esModule?function getDefault(){return module['default']}:function getModuleExports(){return module};__webpack_require__.d(getter,'a',getter);return getter};__webpack_require__.o=function(object,property){return Object.prototype.hasOwnProperty.call(object,property)};__webpack_require__.p="";return __webpack_require__(__webpack_require__.s=53)})([(function(module,exports,__webpack_require__){"use strict";var bind=__webpack_require__(7);var toString=Object.prototype.toString;function isArray(val){return toString.call(val)==='[object Array]'}
...
return pos}
function findFirst(pred,from,to){var dir=from>to?-1:1;while(!0){if(from==to){return from}
...
builder.pos+=text.length}else{content=document.createDocumentFragment();var pos=0;for(;;){special.lastIndex=pos;var m=special.exec(text);var skipped=m?m.index-pos:text.length-pos;if(skipped){var txt=document.createTextNode(displayText.slice(pos,pos+skipped));if(ie&&ie_version<9){content.appendChild(elt("span",[txt]))}
...
return}
var len=allText.length,pos=0,i=1,text="",style,css;var nextChange=0,spanStyle,spanEndStyle,spanStartStyle,title,collapsed;while(!0){if(nextChange==pos){spanStyle=spanEndStyle=spanStartStyle=title=css="";collapsed=null;nextChange=Infinity;var foundBookmarks=[],endStyles=(void 0);for(var j=0;j<spans.length;++j){var sp=spans[j],m=sp.marker;if(m.type=="bookmark"&&sp.from==pos&&m.widgetNode){foundBookmarks.push(m)}else if(sp.from<=pos&&(sp.to==null||sp.to>pos||m.collapsed&&sp.to==pos&&sp.from==pos)){if(sp.to!=null&&sp.to!=pos&&nextChange>sp.to){nextChange=sp.to;spanEndStyle=""}
...
if(pos>=len){break}
var upto=Math.min(len,nextChange);for(;;){if(text){var end=pos+text.length;if(!collapsed){var tokenText=end>upto?text.slice(0,upto-pos):text;builder.addToken(builder,tokenText,style?style+spanStyle:spanStyle,spanStartStyle,pos+tokenText.length==nextChange?spanEndStyle:"",title,css)}
...
if(x<0){x=0}
var lineObj=getLine(doc,lineN);while(!0){var found=coordsCharInner(cm,lineObj,lineN,x,y);var merged=collapsedSpanAtEnd(lineObj);var mergedPos=merged&&merged.find(0,!0);if(merged&&(found.ch>mergedPos.from.ch||found.ch==mergedPos.from.ch&&found.xRel>0))
...
return!0});signalLater(cm,"lineWidgetAdded",cm,widget,typeof handle=="number"?handle:lineNo(handle));return widget}
...
defineMode.apply(this,arguments)};CodeMirror$1.defineMIME=defineMIME;CodeMirror$1.defineMode("null",function(){return({token:function(stream){return stream.skipToEnd()}})});CodeMirror$1.defineMIME("text/plain","null");CodeMirror$1.defineExtension=function(name,func){CodeMirror$1.prototype[name]=func};CodeMirror$1.defineDocExtension=function(name,func){Doc.prototype[name]=func};CodeMirror$1.fromTextArea=fromTextArea;addLegacyProps(CodeMirror$1);CodeMirror$1.version="5.34.0";return CodeMirror$1})))}),(function(module,exports,__webpack_require__){"use strict";(function(process){var utils=__webpack_require__(0);var normalizeHeaderName=__webpack_require__(30);var PROTECTION_PREFIX=/^\)\]\}',?\n/;var DEFAULT_CONTENT_TYPE={'Content-Type':'application/x-www-form-urlencoded'};function setContentTypeIfUnset(headers,value){if(!utils.isUndefined(headers)&&utils.isUndefined(headers['Content-Type'])){headers['Content-Type']=value}}
function getDefaultAdapter(){var adapter;if(typeof XMLHttpRequest!=='undefined'){adapter=__webpack_require__(3)}else if(typeof process!=='undefined'){adapter=__webpack_require__(3)}
return adapter}
...
return fn.apply(thisArg,args)}}}),(function(module,exports,__webpack_require__){(function(mod){if(!0)
mod(__webpack_require__(1));else if(typeof define=="function"&&define.amd)
...
if(modeCfg.xml&&ch==='<'&&stream.match(/^(!--|[a-z]+(?:\s+[a-z_:.\-]+(?:\s*=\s*[^ >]+)?)*\s*>)/i,!1)){var end=stream.string.indexOf(">",stream.pos);if(end!=-1){var atts=stream.string.substring(stream.start,end);if(/markdown\s*=\s*('|"){0,1}1('|"){0,1}/.test(atts))state.md_inside=!0}
...
return CodeMirror.Pass},blankLine:blankLine,getType:getType,closeBrackets:"()[]{}''\"\"``",fold:"markdown"};return mode},"xml");CodeMirror.defineMIME("text/markdown","markdown");CodeMirror.defineMIME("text/x-markdown","markdown")})}),(function(module,exports,__webpack_require__){(function(mod){if(!0)
mod(__webpack_require__(1));else if(typeof define=="function"&&define.amd)
...
CodeMirror.defineMIME("text/html",{name:"xml",htmlMode:!0})})}),(function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;(function(global,factory){"use strict";if(typeof module==="object"&&typeof module.exports==="object"){module.exports=global.document?factory(global,!0):function(w){if(!w.document){throw new Error("jQuery requires a window with a document")}
...
return jQuery})}),(function(module,exports){var g;g=(function(){return this})();try{g=g||Function("return this")()||(1,eval)("this")}catch(e){if(typeof window==="object")
g=window}
module.exports=g}),(function(module,exports,__webpack_require__){__webpack_require__(33);$(window).on('load',function(){$('.loading-page').removeClass('is--loading');$('.home').addClass('is--loaded');$('.error').addClass('is--loaded')});$('.accordion__content').hide();$('.accordion__content').first().show();$('.accordion__panel').first().addClass('is--open');$('.accordion__title').click(function(){$('.accordion__panel').removeClass('is--open');$(this).parent().addClass('is--open');$('.accordion__content').slideUp(200);$(this).next('.accordion__content').slideDown(200)});$('li[data-tab], .tabs__content').first().addClass('is--active');$('.tabs__content').first().addClass('is--active');$('li[data-tab]').click(function(){var thisTab=$(this).attr('data-tab');var tab=$('.tabs__content'+'[data-tab="'+thisTab+'"]');$('li[data-tab]').removeClass('is--active');$(this).addClass('is--active');$('.tabs__content').removeClass('is--active');tab.addClass('is--active')});$('.dropdown').mouseenter(function(){$(this).addClass('is--active')});$('.dropdown').mouseleave(function(){$(this).removeClass('is--active')});$('.dropdown-menu').mouseleave(function(){$(this).parent().removeClass('is--active')});$('.alert--notify').click(function(){$(this).fadeOut(200)});var offCanvasTrigger=$('.off-canvas__trigger');var offCanvas=$('.off-canvas');if(offCanvasTrigger){offCanvasTrigger.on('click',function(){offCanvas.addClass('is--open');overlay.addClass('is--active')})}
var adminOffCanvasTrigger=$('.admin-off-canvas__trigger');var adminOffCanvas=$('.admin-off-canvas');if(adminOffCanvasTrigger){adminOffCanvasTrigger.on('click',function(){adminOffCanvas.addClass('is--open');overlay.addClass('is--active')})}
$('.off-canvas button').on('click',function(){offCanvas.removeClass('is--open')});var modalTrigger=$('.modal__trigger');var modal=$('.modal');modalTrigger.click(function(){var thisModal=$(this).data('modal');var modal=$('.modal[data-modal="'+thisModal+'"]');modal.addClass('is--open');$('.overlay').addClass('is--active');$('body').css('overflow','hidden')});$(".close").on("click",function(){$(".modal").removeClass('is--open');$('.overlay').removeClass('is--active');$('body').css('overflow','scroll')});$(document).keyup(function(e){if(e.keyCode===27){overlay.removeClass('is--active')}});if(offCanvas){$(document).keyup(function(e){if(e.keyCode===27){offCanvas.removeClass('is--open')}})}
if(adminOffCanvas){$(document).keyup(function(e){if(e.keyCode===27){adminOffCanvas.removeClass('is--open')}})}
if(modal){$(document).keyup(function(e){if(e.keyCode===27){modal.removeClass('is--open');$('body').css('overflow','scroll')}})}
var overlay=$('.overlay');if(overlay){overlay.on('click',function(){$(this).removeClass('is--active')})}
if(overlay){overlay.on('click',function(){$('.off-canvas').removeClass('is--open');$('.admin-off-canvas').removeClass('is--open')})}
if(overlay){overlay.on('click',function(){$('.modal').removeClass('is--open');$('body').css('overflow','scroll')})}
var form=$('.contact-form');$(form).submit(function(e){e.preventDefault();var formData=new FormData($(this)[0]);$.ajax({type:'post',url:$(this).attr('action'),data:formData,processData:!1,contentType:!1}).done(function(response){$('input').val('');$('textarea').val('');$('<div class="alert is-success">Your Message Was Sent! We\'ll be in touch.</div>').insertAfter(form);console.log('success'+response)}).fail(function(data){$('input').val('');$('textarea').val('');$('<div class="alert is-error">Oh no! Something went wrong, try again.</div>').insertAfter(form);console.log('fail'+data)})});$('.hero-carousel').slick({dots:!1,arrows:!1,autoplay:!0,infinite:!0,autoplaySpeed:9000,slidesToShow:1,slidesToScroll:1,draggable:!1});$('.slick-dots button').empty();$('.trainer__container').slick({dots:!1,arrows:!0,autoplay:!0,infinite:!0,autoplaySpeed:9000,slidesToShow:4,slidesToScroll:4,draggable:!1,responsive:[{breakpoint:1025,settings:{slidesToShow:3,slidesToScroll:3,draggable:!0}},{breakpoint:769,settings:{slidesToShow:2,slidesToScroll:2}},{breakpoint:513,settings:{slidesToShow:1,slidesToScroll:1}}]});$('.slick-dots button').empty();$('.slick-prev').html("<i class=\"fa fa-chevron-left\"></i>");$('.slick-next').html("<i class=\"fa fa-chevron-right\"></i>");$('.testimonies__container').slick({dots:!1,arrows:!0,autoplay:!0,infinite:!0,autoplaySpeed:9000,slidesToShow:1,slidesToScroll:1,draggable:!1});$('.slick-dots button').empty();$('.slick-prev').html("<i class=\"fa fa-angle-left\"></i>");$('.slick-next').html("<i class=\"fa fa-angle-right\"></i>");var userFeed=new Instafeed({get:'user',userId:'6658374205',accessToken:'6658374205.c31c536.f8dc966c41004a10bbce7df3e4e81a44',resolution:'standard_resolution',limit:6,sort:'most-recent',template:'<a href="{{link}}" target="_blank"><img src="{{image}}" /></a>'});userFeed.run();$('a[href^="#"]').on('click',function(event){var target=$(this.getAttribute('href'));if(target.length){event.preventDefault();$('html, body').stop().animate({scrollTop:target.offset().top},1000)}});$('.go-back').on('click',function(){window.history.back()});function readURL(input){if(input.files&&input.files[0]){var reader=new FileReader();reader.onload=function(e){$('.image-preview').attr('src',e.target.result)};reader.readAsDataURL(input.files[0])}}
$('.image-upload input').change(function(){$(this).parent().find('span').hide();readURL(this);$('.image-preview').show()});$('.alert').delay(6000).fadeOut("slow");$('#buttonDisplay').change(function(){if($(this).prop('checked')==!0){$('.button-options').addClass('hidden-option');$('.button-options').prop('disabled',!0)}else{$('.button-options').removeClass('hidden-option');$('.button-options').prop('disabled',!1)}});var mde=document.getElementById('mde');if(mde){var simplemde=new SimpleMDE({element:mde,hideIcons:['fullscreen','side-by-side']})}}),(function(module,exports){}),(function(module,exports,__webpack_require__){module.exports=__webpack_require__(16)}),(function(module,exports,__webpack_require__){"use strict";var utils=__webpack_require__(0);var bind=__webpack_require__(7);var Axios=__webpack_require__(18);var defaults=__webpack_require__(2);function createInstance(defaultConfig){var context=new Axios(defaultConfig);var instance=bind(Axios.prototype.request,context);utils.extend(instance,Axios.prototype,context);utils.extend(instance,context);return instance}
var axios=createInstance(defaults);axios.Axios=Axios;axios.create=function create(instanceConfig){return createInstance(utils.merge(defaults,instanceConfig))};axios.Cancel=__webpack_require__(4);axios.CancelToken=__webpack_require__(17);axios.isCancel=__webpack_require__(5);axios.all=function all(promises){return Promise.all(promises)};axios.spread=__webpack_require__(32);module.exports=axios;module.exports.default=axios}),(function(module,exports,__webpack_require__){"use strict";var Cancel=__webpack_require__(4);function CancelToken(executor){if(typeof executor!=='function'){throw new TypeError('executor must be a function.')}
var resolvePromise;this.promise=new Promise(function promiseExecutor(resolve){resolvePromise=resolve});var token=this;executor(function cancel(message){if(token.reason){return}
token.reason=new Cancel(message);resolvePromise(token.reason)})}
CancelToken.prototype.throwIfRequested=function throwIfRequested(){if(this.reason){throw this.reason}};CancelToken.source=function source(){var cancel;var token=new CancelToken(function executor(c){cancel=c});return{token:token,cancel:cancel}};module.exports=CancelToken}),(function(module,exports,__webpack_require__){"use strict";var defaults=__webpack_require__(2);var utils=__webpack_require__(0);var InterceptorManager=__webpack_require__(19);var dispatchRequest=__webpack_require__(20);var isAbsoluteURL=__webpack_require__(28);var combineURLs=__webpack_require__(26);function Axios(instanceConfig){this.defaults=instanceConfig;this.interceptors={request:new InterceptorManager(),response:new InterceptorManager()}}
...
utils.forEach(headers.split('\n'),function parser(line){i=line.indexOf(':');key=utils.trim(line.substr(0,i)).toLowerCase();val=utils.trim(line.substr(i+1));if(key){parsed[key]=parsed[key]?parsed[key]+', '+val:val}});return parsed}}),(function(module,exports,__webpack_require__){"use strict";module.exports=function spread(callback){return function wrap(arr){return callback.apply(null,arr)}}}),(function(module,exports,__webpack_require__){try{window.$=window.jQuery=__webpack_require__(11)}catch(e){}
window.axios=__webpack_require__(15);window.axios.defaults.headers.common['X-Requested-With']='XMLHttpRequest';window.SimpleMDE=__webpack_require__(49);window.slick=__webpack_require__(50);window.Instafeed=__webpack_require__(45)}),(function(module,exports,__webpack_require__){"use strict";exports.byteLength=byteLength
...
output+='='}
parts.push(output)
return parts.join('')}}),(function(module,exports,__webpack_require__){"use strict";(function(global){var base64=__webpack_require__(34)
...
dst[i+offset]=src[i]}
return i}
function isnan(val){return val!==val}}.call(exports,__webpack_require__(12)))}),(function(module,exports){var toString={}.toString;module.exports=Array.isArray||function(arr){return toString.call(arr)=='[object Array]'}}),(function(module,exports,__webpack_require__){"use strict";var Typo=__webpack_require__(51);function CodeMirrorSpellChecker(options){options=options||{};if(typeof options.codeMirrorInstance!=="function"||typeof options.codeMirrorInstance.defineMode!=="function"){console.log("CodeMirror Spell Checker: You must provide an instance of CodeMirror via the option `codeMirrorInstance`");return}
...
function isEmpty(cm){return(cm.lineCount()===1)&&(cm.getLine(0)==="")}})}),(function(module,exports,__webpack_require__){(function(mod){if(!0)
mod(__webpack_require__(1));else if(typeof define=="function"&&define.amd)
define(["../../lib/codemirror"],mod);else mod(CodeMirror)})(function(CodeMirror){"use strict";var listRE=/^(\s*)(>[> ]*|[*+-] \[[x ]\]\s|[*+-]\s|(\d+)([.)]))(\s*)/,emptyListRE=/^(\s*)(>[> ]*|[*+-] \[[x ]\]|[*+-]|(\d+)[.)])(\s*)$/,unorderedListRE=/[*+-]\s/;CodeMirror.commands.newlineAndIndentContinueMarkdownList=function(cm){if(cm.getOption("disableInput"))return CodeMirror.Pass;var ranges=cm.listSelections(),replacements=[];for(var i=0;i<ranges.length;i++){var pos=ranges[i].head;var eolState=cm.getStateAfter(pos.line);var inList=eolState.list!==!1;var inQuote=eolState.quote!==0;var line=cm.getLine(pos.line),match=listRE.exec(line);var cursorBeforeBullet=/^\s*$/.test(line.slice(0,pos.ch));if(!ranges[i].empty()||(!inList&&!inQuote)||!match||cursorBeforeBullet){cm.execCommand("newlineAndIndent");return}
...
if(cmp(to,coverEnd.to)>0){if(to.line-coverEnd.from.line<CHUNK_SIZE){array.pop().clear();coverRange(cm,coverEnd.from,to)}else{coverRange(cm,coverEnd.to,to)}}}})}),(function(module,exports,__webpack_require__){(function(mod){if(!0)
mod(__webpack_require__(1),__webpack_require__(9),__webpack_require__(8));else if(typeof define=="function"&&define.amd)
...
if(stream.sol()||state.ateSpace){state.ateSpace=!1;if(modeConfig.gitHubSpice!==!1){if(stream.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+@)?(?=.{0,6}\d)(?:[a-f0-9]{7,40}\b)/)){state.combineTokens=!0;return"link"}else if(stream.match(/^(?:[a-zA-Z0-9\-_]+\/)?(?:[a-zA-Z0-9\-_]+)?#[0-9]+\b/)){state.combineTokens=!0;return"link"}}}
...
if(/\+json$/.test(mime))return CodeMirror.findModeByMIME("application/json")};CodeMirror.findModeByExtension=function(ext){for(var i=0;i<CodeMirror.modeInfo.length;i++){var info=CodeMirror.modeInfo[i];if(info.ext)for(var j=0;j<info.ext.length;j++)
...
if(info.alias[j].toLowerCase()==name)return info}}})}),(function(module,exports){exports.read=function(buffer,offset,isLE,mLen,nBytes){var e,m
...
buffer[offset+i-d]|=s*128}}),(function(module,exports,__webpack_require__){var __WEBPACK_AMD_DEFINE_FACTORY__,__WEBPACK_AMD_DEFINE_ARRAY__,__WEBPACK_AMD_DEFINE_RESULT__;(function(){var Instafeed;Instafeed=(function(){function Instafeed(params,context){var option,value;this.options={target:'instafeed',get:'popular',resolution:'thumbnail',sortBy:'none',links:!0,mock:!1,useHttp:!1};if(typeof params==='object'){for(option in params){value=params[option];this.options[option]=value}}
...
return filteredImages};return Instafeed})();(function(root,factory){if(!0){return!(__WEBPACK_AMD_DEFINE_ARRAY__=[],__WEBPACK_AMD_DEFINE_FACTORY__=(factory),__WEBPACK_AMD_DEFINE_RESULT__=(typeof __WEBPACK_AMD_DEFINE_FACTORY__==='function'?(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports,__WEBPACK_AMD_DEFINE_ARRAY__)):__WEBPACK_AMD_DEFINE_FACTORY__),__WEBPACK_AMD_DEFINE_RESULT__!==undefined&&(module.exports=__WEBPACK_AMD_DEFINE_RESULT__))}else if(typeof module==='object'&&module.exports){return module.exports=factory()}else{return root.Instafeed=factory()}})(this,function(){return Instafeed})}).call(this)}),(function(module,exports,__webpack_require__){(function(global){;(function(){'use strict';var block={newline:/^\n+/,code:/^( {4}[^\n]+\n*)+/,fences:noop,hr:/^( *[-*_]){3,} *(?:\n+|$)/,heading:/^ *(#{1,6}) *([^\n]+?) *#* *(?:\n+|$)/,nptable:noop,lheading:/^([^\n]+)\n *(=|-){2,} *(?:\n+|$)/,blockquote:/^( *>[^\n]+(\n(?!def)[^\n]+)*\n*)+/,list:/^( *)(bull) [\s\S]+?(?:hr|def|\n{2,}(?! )(?!\1bull )\n*|\s*$)/,html:/^ *(?:comment *(?:\n|\s*$)|closed *(?:\n{2,}|\s*$)|closing *(?:\n{2,}|\s*$))/,def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +["(]([^\n]+)[")])? *(?:\n+|$)/,table:noop,paragraph:/^((?:[^\n]+\n?(?!hr|heading|lheading|blockquote|tag|def))+)\n*/,text:/^[^\n]+/};block.bullet=/(?:[*+-]|\d+\.)/;block.item=/^( *)(bull) [^\n]*(?:\n(?!\1bull )[^\n]*)*/;block.item=replace(block.item,'gm')(/bull/g,block.bullet)();block.list=replace(block.list)(/bull/g,block.bullet)('hr','\\n+(?=\\1?(?:[-*_] *){3,}(?:\\n+|$))')('def','\\n+(?='+block.def.source+')')();block.blockquote=replace(block.blockquote)('def',block.def)();block._tag='(?!(?:'+'a|em|strong|small|s|cite|q|dfn|abbr|data|time|code'+'|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo'+'|span|br|wbr|ins|del|img)\\b)\\w+(?!:/|[^\\w\\s@]*@)\\b';block.html=replace(block.html)('comment',/<!--[\s\S]*?-->/)('closed',/<(tag)[\s\S]+?<\/\1>/)('closing',/<tag(?:"[^"]*"|'[^']*'|[^'">])*?>/)(/tag/g,block._tag)();block.paragraph=replace(block.paragraph)('hr',block.hr)('heading',block.heading)('lheading',block.lheading)('blockquote',block.blockquote)('tag','<'+block._tag)('def',block.def)();block.normal=merge({},block);block.gfm=merge({},block.normal,{fences:/^ *(`{3,}|~{3,})[ \.]*(\S+)? *\n([\s\S]*?)\s*\1 *(?:\n+|$)/,paragraph:/^/,heading:/^ *(#{1,6}) +([^\n]+?) *#* *(?:\n+|$)/});block.gfm.paragraph=replace(block.paragraph)('(?!','(?!'+block.gfm.fences.source.replace('\\1','\\2')+'|'+block.list.source.replace('\\1','\\3')+'|')();block.tables=merge({},block.gfm,{nptable:/^ *(\S.*\|.*)\n *([-:]+ *\|[-| :]*)\n((?:.*\|.*(?:\n|$))*)\n*/,table:/^ *\|(.+)\n *\|( *[-:]+[-| :]*)\n((?: *\|.*(?:\n|$))*)\n*/});function Lexer(options){this.tokens=[];this.tokens.links={};this.options=options||marked.defaults;this.rules=block.normal;if(this.options.gfm){if(this.options.tables){this.rules=block.tables}else{this.rules=block.gfm}}}
...
if(cap=this.rules.code.exec(src)){src=src.substring(cap[0].length);out+=this.renderer.codespan(escape(cap[2].trim(),!0));continue}
...
return}
try{if(opt)opt=merge({},marked.defaults,opt);return Parser.parse(Lexer.lex(src,opt),opt)}catch(e){e.message+='\nPlease report this to https://github.com/chjj/marked.';if((opt||marked.defaults).silent){return'<p>An error occurred:</p><pre>'+escape(e.message+'',!0)+'</pre>'}
throw e}}
marked.options=marked.setOptions=function(opt){merge(marked.defaults,opt);return marked};marked.defaults={gfm:!0,tables:!0,breaks:!1,pedantic:!1,sanitize:!1,sanitizer:null,mangle:!0,smartLists:!1,silent:!1,highlight:null,langPrefix:'lang-',smartypants:!1,headerPrefix:'',renderer:new Renderer,xhtml:!1,baseUrl:null};marked.Parser=Parser;marked.parser=Parser.parse;marked.Renderer=Renderer;marked.Lexer=Lexer;marked.lexer=Lexer.lex;marked.InlineLexer=InlineLexer;marked.inlineLexer=InlineLexer.output;marked.parse=marked;if(!0){module.exports=marked}else if(typeof define==='function'&&define.amd){define(function(){return marked})}else{this.marked=marked}}).call(function(){return this||(typeof window!=='undefined'?window:global)}())}.call(exports,__webpack_require__(12)))}),(function(module,exports){var process=module.exports={};var cachedSetTimeout;var cachedClearTimeout;function defaultSetTimout(){throw new Error('setTimeout has not been defined')}
...
process.binding=function(name){throw new Error('process.binding is not supported')};process.cwd=function(){return'/'};process.chdir=function(dir){throw new Error('process.chdir is not supported')};process.umask=function(){return 0}}),(function(module,exports,__webpack_require__){var CodeMirror=__webpack_require__(1);CodeMirror.commands.tabAndIndentMarkdownList=function(cm){var ranges=cm.listSelections();var pos=ranges[0].head;var eolState=cm.getStateAfter(pos.line);var inList=eolState.list!==!1;if(inList){cm.execCommand("indentMore");return}
if(cm.options.indentWithTabs){cm.execCommand("insertTab")}
else{var spaces=Array(cm.options.tabSize+1).join(" ");cm.replaceSelection(spaces)}};CodeMirror.commands.shiftTabAndUnindentMarkdownList=function(cm){var ranges=cm.listSelections();var pos=ranges[0].head;var eolState=cm.getStateAfter(pos.line);var inList=eolState.list!==!1;if(inList){cm.execCommand("indentLess");return}
if(cm.options.indentWithTabs){cm.execCommand("insertTab")}
else{var spaces=Array(cm.options.tabSize+1).join(" ");cm.replaceSelection(spaces)}}}),(function(module,exports,__webpack_require__){"use strict";var CodeMirror=__webpack_require__(1);__webpack_require__(40);__webpack_require__(48);__webpack_require__(38);__webpack_require__(9);__webpack_require__(8);__webpack_require__(39);__webpack_require__(41);__webpack_require__(42);__webpack_require__(10);var CodeMirrorSpellChecker=__webpack_require__(37);var marked=__webpack_require__(46);var isMac=/Mac/.test(navigator.platform);var bindings={"toggleBold":toggleBold,"toggleItalic":toggleItalic,"drawLink":drawLink,"toggleHeadingSmaller":toggleHeadingSmaller,"toggleHeadingBigger":toggleHeadingBigger,"drawImage":drawImage,"toggleBlockquote":toggleBlockquote,"toggleOrderedList":toggleOrderedList,"toggleUnorderedList":toggleUnorderedList,"toggleCodeBlock":toggleCodeBlock,"togglePreview":togglePreview,"toggleStrikethrough":toggleStrikethrough,"toggleHeading1":toggleHeading1,"toggleHeading2":toggleHeading2,"toggleHeading3":toggleHeading3,"cleanBlock":cleanBlock,"drawTable":drawTable,"drawHorizontalRule":drawHorizontalRule,"undo":undo,"redo":redo,"toggleSideBySide":toggleSideBySide,"toggleFullScreen":toggleFullScreen};var shortcuts={"toggleBold":"Cmd-B","toggleItalic":"Cmd-I","drawLink":"Cmd-K","toggleHeadingSmaller":"Cmd-H","toggleHeadingBigger":"Shift-Cmd-H","cleanBlock":"Cmd-E","drawImage":"Cmd-Alt-I","toggleBlockquote":"Cmd-'","toggleOrderedList":"Cmd-Alt-L","toggleUnorderedList":"Cmd-L","toggleCodeBlock":"Cmd-Alt-C","togglePreview":"Cmd-P","toggleSideBySide":"F9","toggleFullScreen":"F11"};var getBindingName=function(f){for(var key in bindings){if(bindings[key]===f){return key}}
...
return _}}))}),(function(module,exports,__webpack_require__){(function(__dirname,Buffer){var Typo;(function(){"use strict";Typo=function(dictionary,affData,wordsData,settings){settings=settings||{};this.dictionary=null;this.rules={};this.dictionaryTable={};this.compoundRules=[];this.compoundRuleCodes={};this.replacementTable=[];this.flags=settings.flags||{};this.memoized={};this.loaded=!1;var self=this;var path;var i,j,_len,_jlen;if(dictionary){self.dictionary=dictionary;if(affData&&wordsData){setup()}
else if(typeof window!=='undefined'&&'chrome' in window&&'extension' in window.chrome&&'getURL' in window.chrome.extension){if(settings.dictionaryPath){path=settings.dictionaryPath}
else{path="typo/dictionaries"}
if(!affData)readDataFile(chrome.extension.getURL(path+"/"+dictionary+"/"+dictionary+".aff"),setAffData);if(!wordsData)readDataFile(chrome.extension.getURL(path+"/"+dictionary+"/"+dictionary+".dic"),setWordsData)}
else{if(settings.dictionaryPath){path=settings.dictionaryPath}
else if(!0){path=__dirname+'/dictionaries'}
else{path='./dictionaries'}
if(!affData)readDataFile(path+"/"+dictionary+"/"+dictionary+".aff",setAffData);if(!wordsData)readDataFile(path+"/"+dictionary+"/"+dictionary+".dic",setWordsData)}}
function readDataFile(url,setFunc){var response=self._readFile(url,null,settings.asyncLoad);if(settings.asyncLoad){response.then(function(data){setFunc(data)})}
else{setFunc(response)}}
function setAffData(data){affData=data;if(wordsData){setup()}}
function setWordsData(data){wordsData=data;if(affData){setup()}}
function setup(){self.rules=self._parseAFF(affData);self.compoundRuleCodes={};for(i=0,_len=self.compoundRules.length;i<_len;i++){var rule=self.compoundRules[i];for(j=0,_jlen=rule.length;j<_jlen;j++){self.compoundRuleCodes[rule[j]]=[]}}
if("ONLYINCOMPOUND" in self.flags){self.compoundRuleCodes[self.flags.ONLYINCOMPOUND]=[]}
self.dictionaryTable=self._parseDIC(wordsData);for(i in self.compoundRuleCodes){if(self.compoundRuleCodes[i].length===0){delete self.compoundRuleCodes[i]}}
for(i=0,_len=self.compoundRules.length;i<_len;i++){var ruleText=self.compoundRules[i];var expressionText="";for(j=0,_jlen=ruleText.length;j<_jlen;j++){var character=ruleText[j];if(character in self.compoundRuleCodes){expressionText+="("+self.compoundRuleCodes[character].join("|")+")"}
else{expressionText+=character}}
self.compoundRules[i]=new RegExp(expressionText,"i")}
self.loaded=!0;if(settings.asyncLoad&&settings.loadedCallback){settings.loadedCallback(self)}}
return this};Typo.prototype={load:function(obj){for(var i in obj){if(obj.hasOwnProperty(i)){this[i]=obj[i]}}
return this},_readFile:function(path,charset,async){charset=charset||"utf8";if(typeof XMLHttpRequest!=='undefined'){var promise;var req=new XMLHttpRequest();req.open("GET",path,async);if(async){promise=new Promise(function(resolve,reject){req.onload=function(){if(req.status===200){resolve(req.responseText)}
else{reject(req.statusText)}};req.onerror=function(){reject(req.statusText)}})}
if(req.overrideMimeType)
req.overrideMimeType("text/plain; charset="+charset);req.send(null);return async?promise:req.responseText}
else if(!0){var fs=__webpack_require__(52);try{if(fs.existsSync(path)){var stats=fs.statSync(path);var fileDescriptor=fs.openSync(path,'r');var buffer=new Buffer(stats.size);fs.readSync(fileDescriptor,buffer,0,buffer.length,null);return buffer.toString(charset,0,buffer.length)}
else{console.log("Path "+path+" does not exist.")}}catch(e){console.log(e);return''}}},_parseAFF:function(data){var rules={};var line,subline,numEntries,lineParts;var i,j,_len,_jlen;data=this._removeAffixComments(data);var lines=data.split("\n");for(i=0,_len=lines.length;i<_len;i++){line=lines[i];var definitionParts=line.split(/\s+/);var ruleType=definitionParts[0];if(ruleType=="PFX"||ruleType=="SFX"){var ruleCode=definitionParts[1];var combineable=definitionParts[2];numEntries=parseInt(definitionParts[3],10);var entries=[];for(j=i+1,_jlen=i+1+numEntries;j<_jlen;j++){subline=lines[j];lineParts=subline.split(/\s+/);var charactersToRemove=lineParts[2];var additionParts=lineParts[3].split("/");var charactersToAdd=additionParts[0];if(charactersToAdd==="0")charactersToAdd="";var continuationClasses=this.parseRuleCodes(additionParts[1]);var regexToMatch=lineParts[4];var entry={};entry.add=charactersToAdd;if(continuationClasses.length>0)entry.continuationClasses=continuationClasses;if(regexToMatch!=="."){if(ruleType==="SFX"){entry.match=new RegExp(regexToMatch+"$")}
...
else if(ruleType==="COMPOUNDRULE"){numEntries=parseInt(definitionParts[1],10);for(j=i+1,_jlen=i+1+numEntries;j<_jlen;j++){line=lines[j];lineParts=line.split(/\s+/);this.compoundRules.push(lineParts[1])}
i+=numEntries}
else if(ruleType==="REP"){lineParts=line.split(/\s+/);if(lineParts.length===3){this.replacementTable.push([lineParts[1],lineParts[2]])}}
else{this.flags[ruleType]=definitionParts[1]}}
return rules},_removeAffixComments:function(data){data=data.replace(/^\s*#.*$/mg,"");data=data.replace(/^\s\s*/m,'').replace(/\s\s*$/m,'');data=data.replace(/\n{2,}/g,"\n");data=data.replace(/^\s\s*/,'').replace(/\s\s*$/,'');return data},_parseDIC:function(data){data=this._removeDicComments(data);var lines=data.split("\n");var dictionaryTable={};function addWord(word,rules){if(!dictionaryTable.hasOwnProperty(word)){dictionaryTable[word]=null}
if(rules.length>0){if(dictionaryTable[word]===null){dictionaryTable[word]=[]}
...
return flags}
else if(this.flags.FLAG==="num"){return textCodes.split(",")}},_applyRule:function(word,rule){var entries=rule.entries;var newWords=[];for(var i=0,_len=entries.length;i<_len;i++){var entry=entries[i];if(!entry.match||word.match(entry.match)){var newWord=word;if(entry.remove){newWord=newWord.replace(entry.remove,"")}
...
return newWords},check:function(aWord){if(!this.loaded){throw "Dictionary not loaded."}
var trimmedWord=aWord.replace(/^\s\s*/,'').replace(/\s\s*$/,'');if(this.checkExact(trimmedWord)){return!0}
...
return!1},checkExact:function(word){if(!this.loaded){throw "Dictionary not loaded."}
var ruleCodes=this.dictionaryTable[word];var i,_len;if(typeof ruleCodes==='undefined'){if("COMPOUNDMIN" in this.flags&&word.length>=this.flags.COMPOUNDMIN){for(i=0,_len=this.compoundRules.length;i<_len;i++){if(word.match(this.compoundRules[i])){return!0}}}}
else if(ruleCodes===null){return!0}
else if(typeof ruleCodes==='object'){for(i=0,_len=ruleCodes.length;i<_len;i++){if(!this.hasFlag(word,"ONLYINCOMPOUND",ruleCodes[i])){return!0}}}
return!1},hasFlag:function(word,flag,wordFlags){if(!this.loaded){throw "Dictionary not loaded."}
if(flag in this.flags){if(typeof wordFlags==='undefined'){wordFlags=Array.prototype.concat.apply([],this.dictionaryTable[word])}
if(wordFlags&&wordFlags.indexOf(this.flags[flag])!==-1){return!0}}
return!1},alphabet:"",suggest:function(word,limit){if(!this.loaded){throw "Dictionary not loaded."}
limit=limit||5;if(this.memoized.hasOwnProperty(word)){var memoizedLimit=this.memoized[word].limit;if(limit<=memoizedLimit||this.memoized[word].suggestions.length<memoizedLimit){return this.memoized[word].suggestions.slice(0,limit)}}
if(this.check(word))return[];for(var i=0,_len=this.replacementTable.length;i<_len;i++){var replacementEntry=this.replacementTable[i];if(word.indexOf(replacementEntry[0])!==-1){var correctedWord=word.replace(replacementEntry[0],replacementEntry[1]);if(this.check(correctedWord)){return[correctedWord]}}}
var self=this;self.alphabet="abcdefghijklmnopqrstuvwxyz";function edits1(words){var rv=[];var ii,i,j,_iilen,_len,_jlen;for(ii=0,_iilen=words.length;ii<_iilen;ii++){var word=words[ii];for(i=0,_len=word.length+1;i<_len;i++){var s=[word.substring(0,i),word.substring(i)];if(s[1]){rv.push(s[0]+s[1].substring(1))}
if(s[1].length>1&&s[1][1]!==s[1][0]){rv.push(s[0]+s[1][1]+s[1][0]+s[1].substring(2))}
if(s[1]){for(j=0,_jlen=self.alphabet.length;j<_jlen;j++){if(self.alphabet[j]!=s[1].substring(0,1)){rv.push(s[0]+self.alphabet[j]+s[1].substring(1))}}}
if(s[1]){for(j=0,_jlen=self.alphabet.length;j<_jlen;j++){rv.push(s[0]+self.alphabet[j]+s[1])}}}}
return rv}
function known(words){var rv=[];for(var i=0,_len=words.length;i<_len;i++){if(self.check(words[i])){rv.push(words[i])}}
return rv}
function correct(word){var ed1=edits1([word]);var ed2=edits1(ed1);var corrections=known(ed1.concat(ed2));var i,_len;var weighted_corrections={};for(i=0,_len=corrections.length;i<_len;i++){if(!(corrections[i]in weighted_corrections)){weighted_corrections[corrections[i]]=1}
else{weighted_corrections[corrections[i]]+=1}}
var sorted_corrections=[];for(i in weighted_corrections){if(weighted_corrections.hasOwnProperty(i)){sorted_corrections.push([i,weighted_corrections[i]])}}
function sorter(a,b){if(a[1]<b[1]){return-1}
return 1}
sorted_corrections.sort(sorter).reverse();var rv=[];var capitalization_scheme="lowercase";if(word.toUpperCase()===word){capitalization_scheme="uppercase"}
else if(word.substr(0,1).toUpperCase()+word.substr(1).toLowerCase()===word){capitalization_scheme="capitalized"}
for(i=0,_len=Math.min(limit,sorted_corrections.length);i<_len;i++){if("uppercase"===capitalization_scheme){sorted_corrections[i][0]=sorted_corrections[i][0].toUpperCase()}
...
if(!self.hasFlag(sorted_corrections[i][0],"NOSUGGEST")){rv.push(sorted_corrections[i][0])}}
return rv}
this.memoized[word]={'suggestions':correct(word),'limit':limit};return this.memoized[word].suggestions}}})();if(!0){module.exports=Typo}}.call(exports,"/",__webpack_require__(35).Buffer))}),(function(module,exports){}),(function(module,exports,__webpack_require__){__webpack_require__(13);module.exports=__webpack_require__(14)})])